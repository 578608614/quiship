...
public class EMailLabelDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v15", "EMailLabelDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v15", "EMailRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
