...
public class CustomLabelBoxEntry  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v15", "CustomLabelBoxEntry"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("topLeftCorner");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v15", "TopLeftCorner"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v15", "BottomRightCorner"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/ship/v15", "CustomLabelPosition"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
